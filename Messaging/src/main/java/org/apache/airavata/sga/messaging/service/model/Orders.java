...
public class Orders implements org.apache.thrift.TBase<Orders, Orders._Fields>, java.io.Serializable, Cloneable, Comparable<Orders> {
  ...
  static {
    schemes.put(StandardScheme.class, new OrdersStandardSchemeFactory());
    schemes.put(TupleScheme.class, new OrdersTupleSchemeFactory());
  }
  ...
  public int hashCode() {
    ...
    boolean present_orderAmount = true;
  ...
  private static class OrdersStandardSchemeFactory implements SchemeFactory {
    public OrdersStandardScheme getScheme() {
      return new OrdersStandardScheme();
    }
  }

  private static class OrdersStandardScheme extends StandardScheme<Orders> {
  ...
  private static class OrdersTupleSchemeFactory implements SchemeFactory {
    public OrdersTupleScheme getScheme() {
      return new OrdersTupleScheme();
    }
  }

  private static class OrdersTupleScheme extends TupleScheme<Orders> {
