...
public class JobSubmissionConsumer extends QueueingConsumer {

	private static final Logger logger = LogManager.getLogger(JobSubmissionConsumer.class);

    private MessageHandler handler;
    private Channel channel;
    private Connection connection;

    public JobSubmissionConsumer(MessageHandler messageHandler, Connection connection, Channel channel) {
        super(channel);
