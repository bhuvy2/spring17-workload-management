...
public class DockerContainer implements org.apache.thrift.TBase<DockerContainer, DockerContainer._Fields>, java.io.Serializable, Cloneable, Comparable<DockerContainer> {
  ...
  /** The Constant PARAMETERS_FIELD_DESC. */
   ...
   *
   * @return true, if is sets the image
   */
  ...
  /**
   * Sets the image is set.
   *
   * @param value the new image is set
   */
   ...
   *
   * @return true, if is sets the parameters
   */
  ...
  /**
   * Sets the parameters is set.
   *
   * @param value the new parameters is set
   */
  ...
  /**
   * A factory for creating DockerContainerStandardScheme objects.
   */
  ...
  /**
   * The Class DockerContainerStandardScheme.
   */
  ...
  /**
   * A factory for creating DockerContainerTupleScheme objects.
   */
  ...
  /**
   * The Class DockerContainerTupleScheme.
   */
