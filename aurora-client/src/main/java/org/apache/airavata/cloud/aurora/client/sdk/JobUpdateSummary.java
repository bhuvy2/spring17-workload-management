...
public class JobUpdateSummary implements org.apache.thrift.TBase<JobUpdateSummary, JobUpdateSummary._Fields>, java.io.Serializable, Cloneable, Comparable<JobUpdateSummary> {
  ...
  /**
   * Instantiates a new job update summary.
   */
   ...
   *
   * @return true, if is sets the state
   */
  ...
  /**
   * Sets the state is set.
   *
   * @param value the new state is set
   */
  ...
  /**
   * A factory for creating JobUpdateSummaryStandardScheme objects.
   */
  ...
  /**
   * The Class JobUpdateSummaryStandardScheme.
   */
  ...
  /**
   * A factory for creating JobUpdateSummaryTupleScheme objects.
   */
  ...
  /**
   * The Class JobUpdateSummaryTupleScheme.
   */
