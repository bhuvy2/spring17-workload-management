...
public class JobUpdateQuery implements org.apache.thrift.TBase<JobUpdateQuery, JobUpdateQuery._Fields>, java.io.Serializable, Cloneable, Comparable<JobUpdateQuery> {
  ...
  /** The Constant JOB_KEY_FIELD_DESC. */
  ...
  /** The Constant UPDATE_STATUSES_FIELD_DESC. */
  ...
  /**
   * Instantiates a new job update query.
   */
   ...
   * @param user the user
   * @param updateStatuses the update statuses
   ...
   *
   * @return true, if is sets the job key
   */
  ...
  /**
   * Sets the job key is set.
   *
   * @param value the new job key is set
   */
  ...
  /**
   * Gets the update statuses size.
   *
   * @return the update statuses size
   */
  ...
  /**
   * Gets the update statuses iterator.
   *
   * @return the update statuses iterator
   */
   ...
   *
   * @return true, if is sets the update statuses
   */
  ...
  /**
   * Sets the update statuses is set.
   *
   * @param value the new update statuses is set
   */
  ...
  /**
   * A factory for creating JobUpdateQueryStandardScheme objects.
   */
  ...
  /**
   * The Class JobUpdateQueryStandardScheme.
   */
  ...
  /**
   * A factory for creating JobUpdateQueryTupleScheme objects.
   */
  ...
  /**
   * The Class JobUpdateQueryTupleScheme.
   */
